...
import habits.greencountrymedia.com.habits.db.HabitDbTable
...
class CreateHabitActivity : AppCompatActivity() {
    ...
    fun storeHabit(v: View) {
        if (et_title.isBlank() || et_description.isBlank()) {
            ...
            displayErrorMessage("Your habit needs an engaging title & description")
            return
        ...
        if (id == -1L) {
            displayErrorMessage("Habit could not be stored...Lets don't make this a habit")
        } else {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        && data != null && data.data != null) {
            ...
            Log.d(TAG, "a image was chosen by the user")
